...
class JobInfo(BaseModel):
    ...
    qualifications: str = Field(description="Educational background, certifications, or years of experience required.")
    requirements: str = Field(description="Specific skills, tools, or knowledge needed for the role.")
